...
public class SqliteMessageStore : MessageDatabase<SqliteConnection>
{
    ...
    public SqliteMessageStore(DatabaseSettings database, DurabilitySettings settings,
        ILogger<SqliteMessageStore> logger, IEnumerable<SagaTableDefinition> sagaTypes)
        : base(database, SqlClientFactory.Instance.CreateDataSource(database.ConnectionString), settings, logger, new SqliteMigrator(), SqliteProvider.Instance)
    {
    ...
    {
        return new SqliteNodePersistence(databaseSettings, this);
    }
